...
bool childBedRoomState = true;
bool childAptState = true;
...
void loop() {
  ...
  if (mfrc522.PICC_IsNewCardPresent() && mfrc522.PICC_ReadCardSerial()){
      ...
      if (childBedRoomState == true)
      {
        Serial.println("Child is going out of the room");
        lcd.begin(16, 2);  
        lcd.setCursor(0, 0);// Print a message to the lcd.
        lcd.print("Child gng out bedrm ");
        lcd.setRGB(254,0,0);
      }
      else
      {
        Serial.println("Child is inside the room");
        lcd.begin(16, 2);  
        lcd.setCursor(0, 0);// Print a message to the lcd.
        lcd.print("Child gng in bedrm ");
        lcd.setRGB(254,0,0);
      }
      childBedRoomState = !childBedRoomState;
      delay(1000);
  }
...
/* *****************************RFID 2 ************************************* */
   ...
   if (mfrc522_2.PICC_IsNewCardPresent() && mfrc522_2.PICC_ReadCardSerial()){
      ...
      if (childAptState == true)
      {
        Serial.println("Child is going out of the apt");
        lcd.begin(16, 2);  
        lcd.setCursor(0, 0);// Print a message to the lcd.
        lcd.print("Child gng out apt ");
        lcd.setRGB(254,0,0);
      }
      else{
        Serial.println("Child is inside the apt");
        lcd.begin(16, 2);  
        lcd.setCursor(0, 0);// Print a message to the lcd.
        lcd.print("Child gng in apt ");
        lcd.setRGB(254,0,0);
      }
      childAptState = !childAptState;
      delay(1000);
  }
